...
## Image Segmentation
For the segmentation part, we used Otsu, K-means and Mean Cut segmentation methods, to test which one would fit well to the goals of the project, and we got the following results:

![alt text](https://github.com/rzimmerdev/pdi-2022/blob/main/tests/segmentation/1.jpeg?raw=true)
![alt text](https://github.com/rzimmerdev/pdi-2022/blob/main/tests/segmentation/2.jpeg?raw=true)




## UNet
A convolutional neural network called UNet, that was conceived initially for image segmentation in medical field, was used in an attempt to apply deep learning techniques to the project. However, due to (problems...) we didn't achieve satifactory results.

![alt_text](https://github.com/rzimmerdev/pdi-2022/blob/main/tests/unet/6.jpeg?raw=true)
![alt_text](https://github.com/rzimmerdev/pdi-2022/blob/main/tests/unet/2.jpeg?raw=true)
